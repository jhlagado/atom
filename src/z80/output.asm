...
OU_RESET:                      ; Enter logical-output initialization.
...
OU_CCAP:                       ; Enter the non-mutating capacity check.
...
OU_EMITB:                      ; Enter single-byte IMAGE emission.
...
OU_EMITW:                      ; Enter little-endian word emission.
...
OU_RESER:                      ; Enter uninitialized-range reservation.
...
OU_SORIG:                      ; Enter logical-origin selection.
...
OU_EBREA:                      ; Enter the checked host byte-submission tail.
...
OU_EINS:                       ; Enter parsed-instruction emission.
...
OU_RSLV:                       ; Enter pending-reference resolution for one symbol.
...
OU_RWDOM:                      ; Enter the resolved-expression domain check.
LD   A,(OU_RVAL+2)             ; Inspect the 24-bit extension byte.
