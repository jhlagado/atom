...
| --- | --- | ---: |
| Code and immutable tables | Measured | 11,850 |
| Fixed workspace | Measured | 531 |
| Linked resident extent | Measured | 12,381 |
| Physical margin below 16 KiB | Measured | 4,003 |
...
proof covers Measured 12,381 resident bytes and Measured 12,008 initialized
