...
Measured 13,103 bytes, leaving Measured 3,281 bytes below `$4000`. A TEC target
...
The Debug80 image contains 24 bytes of fail-closed stubs at those names. They
...
five code-bearing parts totalling Measured 94,088 bytes plus a small entry
...
choice against the 3,281-byte resident margin. It is a Hypothesis, not a
