...
Measured 12,499 bytes, leaving Measured 3,885 bytes below `$4000`. A TEC target
...
five generated parts totalling Measured 102,158 bytes plus a small entry
...
choice against the 3,885-byte resident margin. It is a Hypothesis, not a
