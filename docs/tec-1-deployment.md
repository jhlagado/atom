...
Measured 12,502 bytes, leaving Measured 3,882 bytes below `$4000`. A TEC target
...
five generated parts totalling Measured 102,171 bytes plus a small entry
...
choice against the 3,882-byte resident margin. It is a Hypothesis, not a
