...
Measured 12,381 bytes, leaving Measured 4,003 bytes below `$4000`. A TEC target
...
five generated parts totalling Measured 101,631 bytes plus a small entry
...
choice against the 4,003-byte resident margin. It is a Hypothesis, not a
