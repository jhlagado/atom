...
checked native self-host input is Measured 191,988 bytes in ten content parts.
...
and 2,000,000,000 T-states. Atom's measured self-build uses 106,936,101
instructions and 1,139,971,772 T-states.
