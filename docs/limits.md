...
checked native self-host input is Measured 446,311 bytes in twelve content parts.
...
and 2,000,000,000 T-states. Atom's measured self-build uses 121,834,139
instructions and 1,300,366,598 T-states.
