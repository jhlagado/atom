...
checked native self-host input is Measured 401,773 bytes in twelve content parts.
...
and 2,000,000,000 T-states. Atom's measured self-build uses 119,145,949
instructions and 1,270,953,540 T-states.
