...
checked native self-host input is Measured 428,007 bytes in twelve content parts.
...
and 2,000,000,000 T-states. Atom's measured self-build uses 120,765,073
instructions and 1,288,854,476 T-states.
