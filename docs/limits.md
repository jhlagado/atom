...
checked native self-host input is Measured 196,629 bytes in ten content parts.
...
and 2,000,000,000 T-states. Atom's measured self-build uses 107,195,772
instructions and 1,142,704,446 T-states.
