...
The result is 13,430 bytes and must match the pinned core byte for byte.
...
build uses six parts and does not retain the whole 96,462-byte source stream in
Z80 RAM.
